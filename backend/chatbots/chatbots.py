...
class ConversationBot(ChatBot):
    ...
    def chat(self, chat: Chat, human_message: str)-> ChatMessage:
        """
        Generates ChatMessage conversation with the user about given theme and scenario. Takes in account User's language level. 
        """
